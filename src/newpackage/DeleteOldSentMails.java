...
public class DeleteOldSentMails extends Help {
	...
	public static void main(String[] args) {
		...
		if (Help.approveLoginLA(driver)) {
			...
			WebElement deleteOldSentMails = wait.until(ExpectedConditions.visibilityOfElementLocated(
					By.xpath(ConfigurationSystemGeneralPage.getDeleteOldSentMailsStringAttr("xpath"))));

			// need to get string
			setPause(800);

			// clear deleteOldSentMails string
			deleteOldSentMails.clear();

			// type in deleteOldSentMails "0.2"
			deleteOldSentMails.sendKeys("0.2");
