...
public class LoginLogoutLA extends Help {
	 ...
	 * 
	 * // Set GoogleChrome Driver Help.setGCD();
	 * 
	 * // Go to URL /// driver.get(baseUrl);
	 * 
	 * // LoginLA Help.loginLA(driver);
	 * 
	 * // check equals of userName if (Help.approveLoginLA(driver)) { // logout from
	 * LA Help.logoutLA(driver, nameOfUser); } else { System.out.println("TestNO");
	 * }
	 * 
	...
	public static void mLoginLogoutLA() {
		...
		if (Help.approveLoginLA(driver)) {
			...
			System.out.println("TestNO - Agent couldn't log out correctly");
		}
